...
Public Class PowerSensorCalibrationChartForm
    ...
    Public Sub New()
        ...
        Me.Chart.GraphPane.Title.Text = "Power Sensor Calibration"
        Me.Chart.GraphPane.XAxis.Title.Text = "Frequency (GHz)"
        Me.Chart.GraphPane.YAxis.Title.Text = "Calibration Factor (%)"
    End Sub
