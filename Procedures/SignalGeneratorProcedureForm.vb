...
Imports FreeCal.Common
	...
	Public Class SignalGeneratorProcedureForm
		...
		Private Sub InitializeComponent()
			...
			'chkSimulate
			'
			Me.chkSimulate.Font = New System.Drawing.Font("Tahoma", 11!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.World, CType(0,Byte))
		...
		Private Sub FillComboBoxes()
            Me.comboBox1.DataSource = GetGPIBBusDevices([Enum].Parse(GetType(Boards), 0))
            If Me.comboBox1.Items.Count > 0
				Me.comboBox1.SelectedIndex = 0
			End If
		End Sub

		Private Sub Button1Click(sender As System.Object, e As System.EventArgs)
			Dim NewSignalGeneratorProcedure As New SignalGeneratorProcedure(Me.tbDUTAssetNumber.Text)
            NewSignalGeneratorProcedure.DUTAddress = Me.comboBox1.SelectedItem
            NewSignalGeneratorProcedure.DUTBusNumber = Me.nudBusAddress.Value
            NewSignalGeneratorProcedure.DUTAssetNumber = Me.tbDUTAssetNumber.Text
		...
		Private Sub Button2Click(sender As System.Object, e As System.EventArgs)
            ...
            NewSignalGeneratorProcedure.DUTAddress = Me.comboBox1.SelectedItem
            NewSignalGeneratorProcedure.DUTBusNumber = Me.nudBusAddress.Value
            NewSignalGeneratorProcedure.dgResults = Me.dataGrid1
            'Me.dataGrid1.DataSource = NewSignalGeneratorProcedure.CurrentTestResults

			NewSignalGeneratorProcedure.SelectedAudioAnalyzer = Me.Standards.SelectedAudioAnalyzer
			NewSignalGeneratorProcedure.SelectedDUTSignalGenerator = Me.Standards.SelectedDUTSignalGenerator
			NewSignalGeneratorProcedure.SelectedMeasuringReceiver = Me.Standards.SelectedMeasuringReceiver
			NewSignalGeneratorProcedure.SelectedPowerMeter = Me.Standards.SelectedPowerMeter
			NewSignalGeneratorProcedure.SelectedSignalGenerator = Me.Standards.SelectedSignalGenerator
			NewSignalGeneratorProcedure.SelectedSpectrumAnalyzer = Me.Standards.SelectedSpectrumAnalyzer
			NewSignalGeneratorProcedure.Simulate = Me.chkSimulate.Checked
