...
#End Region
    ...
    Private Sub Button1Click(sender As System.Object, e As System.EventArgs)
        Me.SelectedDUTSignalGenerator = Me.cboDUTSignalGenerator.SelectedItem.ToString
        Me.SelectedSignalGenerator = Me.cboHighFrequencySignalGenerator.SelectedItem.ToString
        Me.SelectedMeasuringReceiver = Me.cboMeasuringReceiver.SelectedItem.ToString
        Me.SelectedSpectrumAnalyzer = Me.cboSpectrumAnalyzer.SelectedItem.ToString
        Me.SelectedAudioAnalyzer = Me.cboAudioAnalyzer.SelectedItem.ToString
        Me.SelectedPowerMeter = Me.cboPowerMeter.SelectedItem.ToString
        Me.Close()
    End Sub
