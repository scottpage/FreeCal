...
Imports FreeCal.Instruments.SignalGenerators
	...
	Public Class CounterProcedureStandardsForm
		...
		Public SelectedPowerMeterAddress As Integer = 13
		Public SelectedDUTCounterAddress As Integer = 16
		...
		Private Sub Button1Click(sender As System.Object, e As System.EventArgs)
			...
			Me.SelectedDUTCounterAddress = Me.nudDUTCounter.Value
			Me.SelectedPowerMeterAddress = Me.nudPowerMeter.Value
			Me.Close
		End Sub
