	...
	Public Class Agilent8487AProcedure
		...
		Private Sub BtnTestDUTClick(sender As System.Object, e As System.EventArgs)
			...
			For Each DR As DataRow In Me._Data.Rows
				...
				Thread.Sleep(Me.nudDwellTime.Value)
				...
				P.X = CDbl(ConvertFrequency.Convert(CDbl(DR(0)), Me._TestFrequencySuffix, FrequencyEnum.GHz))
		...
		Private Sub BtnTestStandardClick(sender As System.Object, e As System.EventArgs)
			...
			Me._PowerMeter.Write("SENS1:CORR:CSET1 " & Quote & Me.cbStdSN.SelectedItem & Quote)
		...
		Private Sub SetSourceAmplitude(ByVal desiredAmplitudeSetting As Double, ByVal desiredAmplitudeSuffix As AmplitudeEnum)
			Dim PwrMtrReading As Double = Format(Me._PowerMeter.Sections.Measurements.GetAveragedMeasurement(2, "A"), "#0.000")
			PwrMtrReading = Format(Me._PowerMeter.Sections.Measurements.Measure("A"), "#0.000")
