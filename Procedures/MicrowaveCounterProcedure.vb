...
#Region "Instruments"
    ...
    Private Sub InitializeInstruments()
        ...
        If (Me.DUTCounter Is Nothing) Then
            Select Case Me.SelectedDUTCounter
                Case "Agilent5342A"
...
#End Region
    ...
    Private Sub SetSourceAmplitude(ByVal desiredAmplitudeSetting As Double, ByVal desiredAmplitudeSuffix As AmplitudeEnum, ByVal source As String)
        ...
        ElseIf source = "HighFrequency" Then
            ...
            Thread.Sleep(500)
            PwrMtrReading = Convert.ToDouble(Format(Me.PwrMtr.Sections.Measurements.Measure("A"), "#0.00"))
    ...
    Public Sub FrequencyAccuracyAndDisplayTest()
        If MessageBox.Show("Do you want to test the Frequency Accuracy and Display?", "User Input", MessageBoxButtons.YesNo) = DialogResult.Yes Then
    ...
    Public Sub FrequencyRangeAndInputSensitivityTest()
        If MessageBox.Show("Do you want to test the Low Frequency Range and Display?", "User Input", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            Me.DUTCounter.FrequencyRange = CounterFrequencyRangeEnum.Low
            ...
            Next
        End If
        If MessageBox.Show("Do you want to test the High Frequency Accuracy and Display?", "User Input", MessageBoxButtons.YesNo) = DialogResult.Yes Then
