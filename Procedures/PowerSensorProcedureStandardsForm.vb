...
Imports FreeCal.Instruments.SignalGenerators
	...
	Public Class PowerSensorProcedureStandardsForm
		...
		Public SelectedHighFrequencySourceAddress As Integer = 19
		Public SelectedLowFrequencySourceAddress As Integer = 11
		Public SelectedStdDUTPowerMeterAddress As Integer = 13
		Public SelectedReferencePowerMeterAddress As Integer = 25
		Public SelectedNetworkAnalyzerAddress As Integer = 16
		Public SelectedAttenuatorSwitchDriverAddress As Integer = 28
		...
		Private Sub Button1Click(sender As System.Object, e As System.EventArgs)
			...
			Me.SelectedAttenuatorSwitchDriverAddress = Me.nudAttenuatorSwitchDriver.Value
			Me.SelectedHighFrequencySourceAddress = Me.nudHighFrequencySource.Value
			Me.SelectedLowFrequencySourceAddress = Me.nudLowFrequencySource.Value
			Me.SelectedNetworkAnalyzerAddress = Me.nudNetworkAnalyzer.Value
			Me.SelectedReferencePowerMeterAddress = Me.nudReferencePowerMeter.Value
			Me.SelectedStdDUTPowerMeterAddress = Me.nudStdDUTPowerMeter.Value
			Me.Close
		End Sub
