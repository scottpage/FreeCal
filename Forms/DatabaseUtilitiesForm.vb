...
Imports MySql.Data.MySqlClient
	...
	Public Class DatabaseUtilitiesForm
		...
		Private DBUtils As DatabaseUtilities
		...
		Public Sub New
			...
			Dim DT As DataTable = Me.DBUtils.GetTableNames
		...
		Private Sub InitializeComponent()
			...
			Me.lblAssetNumber.Font = New System.Drawing.Font("Tahoma", 11!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.World)
			...
			Me.lblTableNames.Font = New System.Drawing.Font("Tahoma", 11!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.World)
		...
		Private Sub BtnCreateTablesClick(sender As System.Object, e As System.EventArgs)
			Me.DBUtils.CreateFreeCalDatabases
		End Sub
		
		Private Sub BtnGetDetailsClick(sender As System.Object, e As System.EventArgs)
			If Not (Me.cbTableNames.SelectedItem = "") Then
				Me.dgData.DataMember = ""
				Me.dgData.DataSource = Nothing
				Me.dgData.DataMember = Me.cbTableNames.SelectedItem
				Me.dgData.DataSource = Me.DBUtils.GetTableDetails(Me.cbTableNames.SelectedItem)
			Else
		...
		Private Sub BtnGetRecordsClick(sender As System.Object, e As System.EventArgs)
			If Not (Me.cbTableNames.SelectedItem = "") Then
				...
				Me.dgData.DataSource = Nothing
				Me.dgData.DataMember = Me.cbTableNames.SelectedItem
				Me.dgData.DataSource = Me.DBUtils.GetTableRecords(Me.cbTableNames.SelectedItem)
			Else
				MessageBox.Show("You must select a Table Name!")
			End If
		End Sub
		...
		Private Sub BtnUpdateRecordsClick(sender As System.Object, e As System.EventArgs)
			If Not (Me.tbAssetNumber.Text = "" Or Me.cbTableNames.SelectedItem = "") Then
				Me.dgData.DataMember = ""
				Me.dgData.DataSource = Nothing
				Me.dgData.DataMember = Me.cbTableNames.SelectedItem
				Me.dgData.DataSource = Me.DBUtils.GetTableRecords(Me.cbTableNames.SelectedItem)
		...
		Private Sub BtnDeleteRecordsClick(sender As System.Object, e As System.EventArgs)
			If Not (Me.tbAssetNumber.Text = "" Or Me.cbTableNames.SelectedItem = "") Then
				...
				Me.dgData.DataSource = Nothing
				Me.dgData.DataMember = Me.cbTableNames.SelectedItem
				Me.dgData.DataSource = Me.DBUtils.DeleteTableRecords(Me.cbTableNames.SelectedItem, Me.tbAssetNumber.Text)
			Else
				MessageBox.Show("You must specify an Asset number and a select a Table Name!")
			End If
		End Sub
		...
		Private Sub BtnGetSpecificRecordsClick(sender As System.Object, e As System.EventArgs)
			If Not (Me.tbAssetNumber.Text = "" Or Me.cbTableNames.SelectedItem = "") Then
				...
				Me.dgData.DataSource = Nothing
				Me.dgData.DataMember = Me.cbTableNames.SelectedItem
				Me.dgData.DataSource = Me.DBUtils.GetTableRecords(Me.cbTableNames.SelectedItem, Me.tbAssetNumber.Text)
			Else
				MessageBox.Show("You must specify an Asset number and a select a Table Name!")
			End If
		End Sub
