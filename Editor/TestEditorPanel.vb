...
Public Class TestEditorPanel
    ...
    Private Sub InstrumentDragDrop(sender As System.Object, e As System.Windows.Forms.DragEventArgs) Handles MyBase.DragDrop
        If (e.Data.GetDataPresent(DataFormats.Text)) Then
            ...
            Dim InstrumentType As String = String.Empty
            Select Case InstrumentName
                Case "anritsumg3696a"
            ...
            Select Case InstrumentType
                Case "SignalGenerator"
                    Dim _SignalGeneratorControl As New SignalGeneratorControl(InstrumentName, Convert.ToByte(Me.Tag)) With {
                        .BackColor = Color.Red,
                        .AllowDrop = True
                    }
                    _SignalGeneratorControl.Location = Me.PointToClient(New Point(e.X - Convert.ToInt32((_SignalGeneratorControl.Width / 2)), e.Y - Convert.ToInt32((_SignalGeneratorControl.Height / 2))))
                ...
                Case "NetworkAnalyzer"
                    Dim _NWAControl As New NetworkAnalyzerControl(InstrumentName, Convert.ToByte(Me.Tag)) With {
                        .BackColor = Color.Red,
                        .AllowDrop = True
                    }
                    _NWAControl.Location = Me.PointToClient(New Point(e.X - Convert.ToInt32(_NWAControl.Width / 2), e.Y - Convert.ToInt32(_NWAControl.Height / 2)))
                ...
                Case "PowerMeter"
                    Dim _PowerMeterControl As New PowerMeterControl(InstrumentName, Convert.ToByte(Me.Tag)) With {
                        .BackColor = Color.Red,
                        .AllowDrop = True
                    }
                    _PowerMeterControl.Location = Me.PointToClient(New Point(e.X - Convert.ToInt32(_PowerMeterControl.Width / 2), e.Y - Convert.ToInt32(_PowerMeterControl.Height / 2)))
                ...
                Case "SpectrumAnalyzer"
                    Dim _SpectrumAnalyzerControl As New SpectrumAnalyzerControl(InstrumentName, Convert.ToByte(Me.Tag)) With {
                        .BackColor = Color.Red,
                        .AllowDrop = True
                    }
                    _SpectrumAnalyzerControl.Location = Me.PointToClient(New Point(e.X - Convert.ToInt32(_SpectrumAnalyzerControl.Width / 2), e.Y - Convert.ToInt32(_SpectrumAnalyzerControl.Height / 2)))
